...
4. **関連動画を開閉する** — 動画ページ右側の関連動画欄を矢印ボタンで折りたたみ、動画領域を広げます。

おまけ: ショート動画/ゲームルームの非表示、大文字・小文字の区別。
...
| ショート動画を非表示 | Shorts セクションと一覧内の Shorts 動画カードを隠す | OFF |
| ゲームルームを非表示 | ゲームルームのセクションを隠す | OFF |
